...
func (vb *VB) drainForSnapshot() error {
	...
	// Flush() owns flushMu and the bounded-batch legacy path (P1.6 slice 2,
	// 2026-07-28); the old inline Writes.mu+flushLocked dispatch is gone on
	// this branch. Lock order stays drainMu -> flushMu -> Writes.mu,
	// matching DrainToBackendCtx.
